...
/**
 *  Create a Dino array. Initial size will be 1. For custom size look at `dinoCreateReserve()` 
 */
#define dinoCreate(type) _dino_create(DINO_DEFAULT_SIZE, sizeof(type));

/**
 *  Create a Dino array with a custom initial length.
 *  So if you know you need 32 elements you should do dinoCreateReserve(32, [type]).
 *  This saves on having to remalloc a ton of times.
 */
...
/**
 *  Insert an element value to the Dino array at a certain index. Will automatically resize
 */
 ...
 *  Made to be a helper function for other DinoArray functions. Users be careful.
 */
